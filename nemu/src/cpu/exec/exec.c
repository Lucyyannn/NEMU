...
/* 0x80, 0x81, 0x83 */
make_group(gp1,
    EMPTY, EMPTY, EMPTY, EMPTY,//EX(add), EMPTY, EMPTY, EMPTY,
     EMPTY, EMPTY, EMPTY, EMPTY)//EMPTY,EX(sub), EX(xor), EMPTY) //TODO
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x28 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(G2E,sub,1), IDEX(G2E,sub), IDEXW(E2G,sub,1), IDEX(E2G,sub),
  /* 0x2c */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(I2a,sub,1), IDEX(I2a,sub), EMPTY, EMPTY,
  /* 0x30 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(G2E,xor,1), IDEX(G2E,xor), IDEXW(E2G,xor,1), IDEX(E2G,xor),
  /* 0x34 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(I2a,xor,1), IDEX(I2a,xor), EMPTY, EMPTY,
  ...
  /* 0x98 */	EMPTY, EMPTY, EMPTY, EMPTY,//EMPTY, EMPTY, IDEXW(A,call,1), EMPTY,
  ...
  /* 0xe8 */  EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(A,call,1), EMPTY, EMPTY, EMPTY,
  ...
  /* 0x48 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x4c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x50 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(G,push), IDEX(G,push),IDEX(G,push),IDEX(G,push),
  /* 0x54 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(G,push),IDEX(G,push),IDEX(G,push),IDEX(G,push),
  /* 0x58 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(G,pop), IDEX(G,pop),IDEX(G,pop),IDEX(G,pop),
  /* 0x5c */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEX(G,pop),IDEX(G,pop),IDEX(G,pop),IDEX(G,pop),
  /* 0x60 */	EMPTY, EMPTY, EMPTY, EMPTY,
  ...
  /* 0xc0 */	EMPTY, EMPTY, EMPTY, EMPTY,//EMPTY, EMPTY, IDEX(I,ret), IDEX(,ret),
  /* 0xc4 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xc8 */	EMPTY, EMPTY, EMPTY, EMPTY,//EMPTY, EMPTY, IDEX(I,ret), IDEX(,ret),
  /* 0xcc */	EMPTY, EMPTY, EMPTY, EMPTY,
